...
@DeviceDataSignature(deviceName = INavigationDevice.NAME, methods = {
		@DeviceMethodSignature(
		        header = ReadPositionPulseInData.HEADER,
		...
		@DeviceMethodSignature(
		        header = PositionAskInData.HEADER,
		        methodName = "positionAsk",
		        type = DeviceMethodType.OUTPUT, parameters = {
				@DeviceParameter(name = "x", length = 4, type = DeviceParameterType.SIGNED, unit = "mm"),
				@DeviceParameter(name = "-", length = 1, type = DeviceParameterType.UNSPECIFIED, unit = ""),
				@DeviceParameter(name = "y", length = 4, type = DeviceParameterType.SIGNED, unit = "mm"),
		...
		@DeviceMethodSignature(
		        header = ReadMotionParametersInData.HEADER,
		        methodName = "readMotionParameters",
		        type = DeviceMethodType.OUTPUT, parameters = {
		...
		@DeviceMethodSignature(
		        header = ReadMotionEndDetectionParameterInData.HEADER,
		        methodName = "readMotionEndDetectionParameters",
		        type = DeviceMethodType.OUTPUT,
				parameters = {
...
public class NavigationDataDecoder extends DefaultDecoder {
    ...
    private ReadMotionEndDetectionParameterInData decodeEndMotionParameters(String data) throws IllegalComDataException {
        ...
        MotionEndDetectionParameter parameter = new MotionEndDetectionParameter(
                absDeltaPositionIntegralFactorThreshold, maxUIntegralFactorThreshold, maxUIntegralConstantThreshold,
                timeRangeAnalysis, noAnalysisAtStartupTime);
