...
public class RobotPosition implements IRobotAttribute {
    ...
    private Point2D getAbsolutePosition(Point2D relativePosition) {
     ...
     * of pulse
     */
    public void goPulse(double pulse, IRobotDimension dimension) {
        double distance = (dimension.getLeftMotor().pulseToDistance(pulse) + dimension.getRightMotor().pulseToDistance(
                pulse)) / 2;
        go(distance);
    }
     ...
     */
    public void rotateDistance(double distance, IRobotDimension dimension) {
     ...
     *            the dimension of the robot
     */
    public void rotateDistancePulse(double pulseCount, IRobotDimension dimension) {
        double distance = (dimension.getLeftMotor().pulseToDistance(pulseCount) + dimension.getRightMotor()
                .pulseToDistance(pulseCount)) / 2;
    ...
    public String toString() {
        return getClass().getSimpleName() + "[x=" + centralPoint.x + ", y=" + centralPoint.y + ", alpha="
    ...
    public void updateFromPulses(long left, long right, IRobotDimension dimension) {
