...
@DeviceDataSignature(deviceName = INavigationDevice.NAME, methods = { 
        @DeviceMethodSignature(
                header = BezierMoveOutData.HEADER,
                methodName = "bezier",
                ...
                parameters = { 
                        ...
                        @DeviceParameter(name = "-", length = 1, type = DeviceParameterType.UNSPECIFIED, unit = ""),
                        @DeviceParameter(name = "angle", length = 4, type = DeviceParameterType.SIGNED, unit = "rad"),
                        @DeviceParameter(name = "-", length = 1, type = DeviceParameterType.UNSPECIFIED, unit = ""),
		@DeviceParameter(name = "control distance P0-P1", length = 2, type = DeviceParameterType.SIGNED, unit = "cm"),
		@DeviceParameter(name = "control distance P2-P3", length = 2, type = DeviceParameterType.SIGNED, unit = "cm")
}) })
//@formatter:on
