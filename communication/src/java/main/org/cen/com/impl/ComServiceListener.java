package org.cen.com.impl;

import javax.swing.event.EventListenerList;

import org.cen.com.IComDebugListener;
import org.cen.com.IComServiceListener;
...
/**
 * Default implementation of {@link IComServiceListener}
 */
public class ComServiceListener implements IComServiceListener {
    ...
    public void addDebugListener(IComDebugListener listener) {
        listeners.add(IComDebugListener.class, listener);
    }
    ...
    public void fireDebugListener(String data) {
        ...
        for (int i = l.length - 2; i >= 0; i -= 2) {
            if (l[i] == IComDebugListener.class) {
                try {
                    ((IComDebugListener) l[i + 1]).onRawInData(new RawInData(data));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
